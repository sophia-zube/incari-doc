...
| :--- | :--- | :--- |
| `Remote IP` | **User Input** | The _HTTP(S)_ endpoint \(either a URL or IP address\). |
...
| `Remote IP` | **String** | The _HTTP(S)_ endpoint \(either a URL or IP address\). |
| `Remote Port` | **Int** | The port value. For _HTTP_, the standard is 80 and for *HTTPS*, the standard is 443. |
...
![The HTTP Client Node using Method GET.](../../../.gitbook/assets/httpgetnode20241.png)
...
![The HTTP Client Node using Method POST.](../../../.gitbook/assets/httppostnode20241.png)
...
![The HTTP Client Node using Method PUT.](../../../.gitbook/assets/httpputnode20241.png)
...
![The HTTP Client Node using Method HEAD.](../../../.gitbook/assets/httpheadnode20241.png)
...
![The HTTP Client Node using Method DELETE.](../../../.gitbook/assets/httpdeletenode20241.png)
