...
For more information about _format strings_, please see the [_format strings_ section]() below.

external links at the [bottom of this page](date-time-formatter.md#external-links).]
