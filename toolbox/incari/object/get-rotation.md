...
**Get Rotation** returns the $$X$$, $$Y$$, and $$Z$$ rotation of an **Object** in a **Scene**. The **Object ID** is given as input to the **Node**.
...
**Get Rotation** returns the $$X$$ and $$Y$$ rotation of an **Object** in a **Scene**. The **Object ID** is given as input to the **Node**.
...
| :--- | :--- | :--- |
| _Pulse Output_ \(►\) | **Pulse** | A standard **Output Pulse**, to move onto the next **Node** along the **Logic Branch**, once this **Node** has finished its execution. |
| `Rotation` | **Float** | A **Float** that contains the `Rotation` components measured in Euler angles along the $$X$$ and $$Y$$ axes of the target **Object**. |
