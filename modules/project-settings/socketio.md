...
The **SocketIO Settings** allow the user to manage the **SocketIO Connections** and cover the necessary data to provide functionality to the [**SocketIO** **Nodes**](../../toolbox/communication/socketio/README.md).
...
* [**SocketIO** **Nodes**](../../toolbox/communication/socketio/README.md)
